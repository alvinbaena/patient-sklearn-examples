...
if __name__ == '__main__':
    ...
    decision_tree_predictions = np.load('../../data/predictions/logit_med_dur_model_predictions.npy')
    all_predictions['Gini decision tree'] = decision_tree_predictions
    logit_model_predictions = np.load('../../data/predictions/logit_med_dur_model_predictions.npy')
    ...
    plt.title('ROC Additional Physiological + ICD-9 + All Meds')
