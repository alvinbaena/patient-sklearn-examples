...
if __name__ == '__main__':
    ...
    for i in range(1,5):
        logitmodelInitSAPS=linear_model.LogisticRegressionCV(exploreC, fit_intercept=True, cv=5,  penalty='l2', dual=False,  solver='liblinear',  n_jobs=-1, verbose=1, refit=True, random_state=0,  scoring='f1_weighted')
