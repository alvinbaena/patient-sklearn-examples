...
if __name__ == '__main__':
    ...
    for i in range(0, 5):
        logitmodelInitSAPS = linear_model.LogisticRegressionCV(exploreC, fit_intercept=True, cv=5, penalty='l2',
                                                               dual=False, solver='liblinear', n_jobs=-1, verbose=0,
                                                               refit=True, random_state=0, scoring='f1')
    ...
    exploreC = [0.0001, 0.001, 0.01, 0.1, 1, 10]
    for i in range(0, 5):
        logitmodelAllSAPS = linear_model.LogisticRegressionCV(exploreC, fit_intercept=True, cv=5, penalty='l2',
                                                              dual=False, solver='liblinear', n_jobs=-1, verbose=0,
                                                              refit=True, random_state=0, scoring='f1')
