...
if __name__ == '__main__':
    ...
    for j in range(0, len(poly)):    
        ...
        print "F1-Test linear kernel model score poly"+str(poly[j])+" "+str(f1_score(target_test, predictions, labels=[1,0]))
        ...
        print "F1-Train linear kernel model score poly"+str(poly[j])+" "+str(f1_score(target_train, train_predictions, labels=[1,0]))
